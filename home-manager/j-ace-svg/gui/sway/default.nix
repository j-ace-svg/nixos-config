  ...
  config = lib.mkIf cfg.enable {
      ...
      config = rec {
        ...
        modes = {
          ...
          launch = {
            ...
            "f" = "exec ${terminal} tail -fn +1 ${opts.configPath}/nixos-switch.log; mode default";
            "Shift+f" = "exec ${terminal} tail -fn +1 ${opts.configPath}/nixos-switch.log";
            "h" = "mode docs";
            "Shift+h" = "mode docs";
            "e" = "mode dirs";
            "Shift+e" = "mode dirs";
    ...
    programs.wlogout = {
      ...
      layout = [
        ...
        {
          label = "hibernate";
          action = "systemctl hibernate; swaylock --grace 0 --fade-in 0";
          text = "Hibernate";
          keybind = "h";
        }
        {
