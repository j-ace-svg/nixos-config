{
  ...
  programs.waybar = {
    enable = true;
    settings = {
      # Initial config based on https://github.com/arkboix/sway/
      topbar = {
        layer = "top";
        position = "top";
        height = 30;
        ...
        modules-center = [];
        modules-right = ["custom/playerctl" "clock" "pulseaudio" "backlight" "network" "cpu" "memory" "temperature" "battery" "disk" "custom/uptime" "tray"];
