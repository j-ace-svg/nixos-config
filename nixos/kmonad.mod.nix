# A modded version of the kmonad service, credit to https://github.com/inscapist
{
  config,
  lib,
  pkgs,
...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.paths = builtins.listToAttrs (map mkPath (builtins.attrValues cfg.keyboards));

    systemd.services = builtins.listToAttrs (map mkService (builtins.attrValues cfg.keyboards));
  };
}
