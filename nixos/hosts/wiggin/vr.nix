    ...
    xdg = {
      desktopEntries = {
        valve-URI-steamvr = {
          ...
          exec = "${pkgs.steam-run}/bin/steam-run \"/home/j-ace-svg/.local/share/Steam/steamapps/common/SteamVR/bin/linux64/vrurlhandler\" %U";
          terminal = false;
          noDisplay = true;
          type = "Application";
          categories = ["Game"];
        ...
        valve-URI-vrmonitor = {
          ...
          exec = "${pkgs.steam-run}/bin/steam-run \"/home/j-ace-svg/.local/share/Steam/steamapps/common/SteamVR/bin/linux64/vrmonitor\" %U";
          terminal = false;
          noDisplay = true;
          type = "Application";
          categories = ["Game"];
